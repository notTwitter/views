  ...
  return (
    ...
    <S.Header className="center">
      <S.Nav>
         ...
         <S.UL>
          <S.LI><S.NavLink to=''><img src={homeIcon} alt="" /><span>Home</span></S.NavLink></S.LI>
          <S.LI><S.NavLink to='/notifications'><img src={notificationsIconDark} alt="" /><span>Notifications</span></S.NavLink></S.LI>
